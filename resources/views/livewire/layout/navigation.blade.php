...
<nav x-data="{ open: false }" class="bg-gray-50 dark:bg-zinc-900 border-b border-gray-100 dark:border-gray-700">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            @auth
                ...
                <div class="ishrink-0 flex items-center sm:hidden">
            ...
            @else
                <div class="ishrink-0 flex items-center">
